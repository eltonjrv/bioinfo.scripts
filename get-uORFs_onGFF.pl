...
# The gff contains the annotation of the 5'UTR of each Tb927 protein-coding gene.
# The input2 is also a gff cointaining the CDS features (Tb927-TritrypV5p0.11ChrOnly.pma.sl.tritryp3utr.full.gff3), where this script will only catch the CDS end coordinates.
