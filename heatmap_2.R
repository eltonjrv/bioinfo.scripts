# Script copied from https://github.com/DeWitP/SFG/tree/master/scripts
...
heatmap.2(data.matrix(mydata), Rowv=T, Colv=F, dendrogram = c("row"), scale = "none", keysize=1, breaks = pairs.breaks, col=mycol, trace = "none", symkey = F, density.info = "none", labCol=colnames(mydata), colsep=c(24), sepcolor=c("white"), sepwidth=c(.1,.1), margins = c(7,17))
