...
##################################################################################################################
# ATTENTION: the headline of the fasta files must end with the regexp \d+ bp$ (run readseq.jar to generate this kind of fasta file, but make sure the name of the sequences haven't changed)
# The coverage works for both Query and Sbjct sequences, in the cases that the database contains several short sequences
